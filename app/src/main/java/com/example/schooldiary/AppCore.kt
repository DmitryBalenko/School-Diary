...
object Tr {
    val data = mapOf(
        "ua" to mapOf(
            ...
            "pick_date" to "📅 Обрати точну дату",
            "extra_badge" to "📌 Поза розкладом",
            ...
            "today" to "СЬОГОДНІ",
            "tomorrow" to "ЗАВТРА",
            "day_after_tomorrow" to "ПІСЛЯЗАВТРА",
            "start_of_week" to "ПОЧАТОК ТИЖНЯ",
            "cabinet" to "Кабінет...",
            ...
            "pick_date" to "📅 Выбрать точную дату",
            "extra_tasks" to "📌 Дополнительные задания",
            "extra_badge" to "📌 Вне расписания",
            ...
            "today" to "СЕГОДНЯ",
            "tomorrow" to "ЗАВТРА",
            "day_after_tomorrow" to "ПОСЛЕЗАВТРА",
            "start_of_week" to "НАЧАЛО НЕДЕЛИ",
            ...
            "view_as_list" to "В виде списка",
            "view_as_grid" to "В виде сетки",
            ...
            "view_as_list" to "List view",
            "view_as_grid" to "Grid view",
            ...
            "day_after_tomorrow" to "DAY AFTER TOM.",
            "start_of_week" to "START OF WEEK",
            ...
            "cancel" to "Cancel",
            "pick_date" to "📅 Pick exact date",
            "extra_tasks" to "📌 Extra tasks",
            "extra_badge" to "📌 Out of schedule",
            "delete" to "Delete",
            "add" to "Add",
            "bells" to "Bells",
            "save" to "Save",
